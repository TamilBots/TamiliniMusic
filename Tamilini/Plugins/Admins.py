...
from Tamilini.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat)
from Tamilini.Decorators.admins import AdminRightsCheck
from Tamilini.Decorators.checker import checker, checkerCB
from Tamilini.Inline import audio_markup, primary_markup
...
async def admins(_, message: Message):
    ...
    if message.command[0][1] == "t" or message.command[0][1] == "n":
        ...
        await Tamilini.pytgcalls.leave_group_call(message.chat.id)
        await message.reply_text(
