...
from Tamilini import BOT_USERNAME, db_mem
from Tamilini.Core.PyTgCalls import Queues, Tamilini
from Tamilini.Database import (add_active_chat, is_active_chat, music_off,
                            music_on)
from Tamilini.Inline import (audio_markup, audio_markup2, primary_markup,
                          secondary_markup)
